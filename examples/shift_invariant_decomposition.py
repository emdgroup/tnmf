...
into a number of charactersitic rectangular patches.

Lateral inhibition is used the prefer localized activations
...
for data, title, kwargs in [
        ...
        (img_r_partial[:, 0, 0], 'Partial Reconstructions W*H[i_atom]', dict(cmap='Greys')),
]:
    plot_rows = 4
